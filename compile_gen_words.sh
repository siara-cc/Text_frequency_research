...
COMP_OPTS="-g -std=c++17"
# -fsanitize=address"
g++ ${COMP_OPTS} -L/usr/local/lib -I. -Imisc -I../mimalloc/include -I/usr/local/include -I../usr/include -I../bloom/src -I../lmdb/libraries/liblmdb gen_words_and_phrases.cpp sqlite3.o ../index_research/src/univix_util.cpp ../lmdb/libraries/liblmdb/liblmdb.a -lpthread -ldl -llz4 -lbz2 -lzstd -lz -lsnappy -lbrotlienc -lfasttext -lrocksdb
